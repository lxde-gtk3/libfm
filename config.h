...
/* Define to 1 to enable old custom actions code */
#define HAVE_OLD_ACTIONS 1

/* Have x-scheme/uri handler support */
...
#define PACKAGE_BUGREPORT "http://pcmanfm.sourceforge.net/"

/* Define to the full name of this package. */
#define PACKAGE_NAME "libfm"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "libfm 1.3.2"
